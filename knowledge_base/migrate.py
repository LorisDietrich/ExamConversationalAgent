...
def build_banking_graph(inputs, db):
...
def values_template(values):
    ...
    graql_insert_query += ', has proposal-answer-text "' + values["proposal-answer-text"] + '"'
...
if __name__ == "__main__":
    ...
    inputsMATH1 = [
        {"data_path": "./MATH1/weight", "template": weight_template},
        {"data_path": "./MATH1/category", "template": category_template},
        {"data_path": "./MATH1/values", "template": values_template},
        {"data_path": "./MATH1/question", "template": question_template,},
    ]

    build_banking_graph(inputsIALP, 'IALP')
    build_banking_graph(inputsMATH1, 'MATH1')
